        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all">
            <p className="text-gray-300 mb-6">
              ...
              user-friendly interfaces. My background includes working in
              various tech companies and contributing to open-source projects.
              I'm always eager to learn and improve my skills, so feel free to
              reach out if you're interested in working together or discussing
              projects.
            </p>
