...
export const Contact = () => {
  ...
  return (
    ...
    >
      <RevealOnScroll>
        <div className='w-xs px-4 md:w-md'>
          ...
          <form className='space-y-6' onSubmit={handleSubmit}>
            ...
            <button
              type='submit'
              className='relative w-full cursor-pointer overflow-hidden rounded bg-blue-500 px-6 py-3 font-medium text-white transition hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,246,0.4)]'
            >
              Send Message
            </button>
          </form>
