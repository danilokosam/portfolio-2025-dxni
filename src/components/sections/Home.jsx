...
export const Home = () => {
  return (
    ...
    >
      {/* Presentacion */}
      <div className="text-center z-10 px-4 order-1 md:order-none md:h-[480px] flex flex-col justify-center mt-24">
        ...
        <p className="text-gray-100 text-base md:text-lg mb-8 max-w-lg mx-auto leading-snug">
          ...
          user-friendly interfaces. I've worked on various projects, from small
          side projects to large-scale applications.
        </p>
        <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-4 w-2/3 mx-auto">
          <a
            href="#projects"
